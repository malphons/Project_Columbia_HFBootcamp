function tableout = importPrices(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE2 Import data from a spreadsheet
%   DATA = IMPORTFILE2(FILE) reads data from the first worksheet in the
%   Microsoft Excel spreadsheet file named FILE and returns the data as a
%   table.
%
%   DATA = IMPORTFILE2(FILE,SHEET) reads from the specified worksheet.
%
%   DATA = IMPORTFILE2(FILE,SHEET,STARTROW,ENDROW) reads from the specified
%   worksheet for the specified row interval(s). Specify STARTROW and
%   ENDROW as a pair of scalars or vectors of matching size for
%   dis-contiguous row intervals. To read to the end of the file specify an
%   ENDROW of inf.%
% Example:
%   Data = importfile2('Data_LCO_BrentCrudeOil.xlsx','brent_1D',2,1918);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2017/05/30 19:54:16
...
tableout.Volume = data(:,1);
tableout.Open = data(:,2);
tableout.Close = data(:,3);
tableout.High = data(:,4);
tableout.Low = data(:,5);
