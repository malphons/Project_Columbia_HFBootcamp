function [Date,Volume,Open,Close,High,Low] = importfile1(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE1 Import data from a spreadsheet
%   [Date,Volume,Open,Close,High,Low] = IMPORTFILE1(FILE) reads data from
%   the first worksheet in the Microsoft Excel spreadsheet file named FILE
%   and returns the data as column vectors.
%
%   [Date,Volume,Open,Close,High,Low] = IMPORTFILE1(FILE,SHEET) reads from
...
%   ENDROW of inf.%
% Example:
%   [Date,Volume,Open,Close,High,Low] = importfile1('Data_LCO_BrentCrudeOil.xlsx','brent_1D',2,1918);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2015/06/17 12:18:17
